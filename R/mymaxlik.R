#' Display the likelihood function of a parameter for a given distribution
#'
#' @param lfun given distribution
#' @param x A sample from the distribution
#' @param param a vector containing the parameter
#' @return a graph and data regarding the parameter
#' @examples
